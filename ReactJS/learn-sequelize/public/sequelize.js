...
function getUser() {
    ...
    xhr.onload = function () {
        ...
        users.map(function (user) {
            ...
            row.appendChild(td);
            td = document.createElement('td'); td.textContent = user.age; row.appendChild(td);
            td = document.createElement('td'); td.textContent = user.married ?'기혼' :'미혼'; row.appendChild(td);
...
function getComment(id) {
    ...
    xhr.onload = function () {
        ...
        comments.map(function (comment) {
            ...
            row.appendChild(td);
            var edit = document.createElement('button'); edit.textContent ='수정';
